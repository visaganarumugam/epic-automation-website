  ...
  return (
    <footer className="w-full min-h-[600px] bg-[#18181a] flex flex-col items-center justify-end relative overflow-hidden px-2 py-8">
      ...
      <div className="relative z-10 w-full max-w-8xl mx-auto rounded-3xl bg-[#111112]/90 shadow-2xl px-0 py-0 flex flex-col items-center">
        {/* Shiny border */}
        <div className="rounded-3xl p-[2px] bg-gradient-to-r from-[#FEB130] via-[#fcd48f] to-[#FEB130] w-full">
          <div className="rounded-[22px] bg-[#111112]/95 px-8 md:px-16 py-12 w-full grid grid-cols-1 md:grid-cols-5 gap-y-10 md:gap-y-0 md:gap-x-8 items-start justify-between">
            ...
            <div className="flex flex-col gap-4 min-w-[200px] max-w-xs">
              ...
              <div className="flex flex-col gap-2 mt-2">
                <button className="bg-[#FEB130] text-black font-bold px-6 py-3 rounded-full text-base shadow hover:bg-[#fddca4] transition flex items-center justify-between group">
                  Special Purpose Machines <span className="ml-2 text-lg group-hover:translate-x-1 transition">→</span>
                </button>
                <button className="border border-[#FEB130] text-white font-semibold px-6 py-3 rounded-full text-base hover:bg-[#232325] transition flex items-center justify-between">
                  Customized Solutions <span className="ml-2 text-lg text-[#FEB130] group-hover:translate-x-1 transition">→</span>
                </button>
              </div>
            </div>
            {/* 2. Navigation */}
            <div className="flex flex-col gap-2 min-w-[150px] pl-10 max-w-xs">
              ...
              <ul className="text-gray-300 text-lg  space-y-2 opacity-90">
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>Home</li>
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>About Us</li>
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>Solutions</li>
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>Industries</li>
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>Case Studies</li>
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>Contact</li>
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>FAQs</li>
              </ul>
            </div>
            {/* 3. Legal Info */}
            <div className="flex flex-col gap-2 min-w-[140px] max-w-xs">
              ...
              <ul className="text-gray-300 text-lg space-y-2 opacity-90">
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>Terms & Conditions</li>
                <li className='hover:text-[#FEB130] cursor-pointer transition-all duration-300'>Privacy Policy</li>
              </ul>
            </div>
            {/* 4. Contact */}
            ...
            <div className="flex flex-col gap-2 min-w-[180px] max-w-xs items-end justify-between">
              <div>
                ...
                <button className="border border-[#FEB130] mt-4 text-white font-semibold px-6 py-3 rounded-full text-base hover:bg-[#232325] transition flex items-center justify-between group">
                  Follow on<span className="ml-1">LinkedIn</span> <span className="ml-2 text-lg group-hover:translate-x-1 transition">→</span>
                </button>
                <button className="border border-[#FEB130] mt-2 text-white font-semibold px-6 py-3 rounded-full text-base hover:bg-[#232325] transition flex items-center justify-between group">
