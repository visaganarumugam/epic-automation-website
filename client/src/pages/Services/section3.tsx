...
export default function Section3() {
  return (
    <section className="relative w-full h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
      {/* Background Image */}
      <img
        src="/images/robotarmcenterimage.png"
      ...
      <div className="relative z-20 w-full flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-white text-2xl md:text-5xl font-semibold md:font-normal leading-tight md:leading-tight mb-8 md:mb-10 max-w-3xl mx-auto">
          Ready to experience the speed and<br className="hidden md:block" />simplicity of Snappy?
        </h1>
