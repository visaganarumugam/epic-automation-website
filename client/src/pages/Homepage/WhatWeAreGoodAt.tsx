  ...
  return (
    <section id="what-we-are-good-at" className="w-full min-h-screen bg-[#ffe7b6] flex flex-col justify-center items-center py-6 sm:py-8 md:py-10">
      <div className="max-w-full w-full flex flex-col md:flex-row px-4 sm:px-6 md:px-10">
        {/* Left Column */}
        <FadeUpSection className="flex flex-col justify-start w-full md:w-[67vh] gap-3 sm:gap-12 md:gap-72 pt-2 mb-8 md:mb-0">
          <AnimatedSection
            customAnimation={{ y: 50, opacity: 0, duration: 1, delay: 0.2 }}
          >
            <h1 className="text-4xl md:text-[3.2rem] lg:text-[5.2rem] font-bold text-[#18181a] leading-[1.05] mb-0 text-center md:text-left" style={{fontFamily: 'Gilroy, sans-serif'}}>Our Expertise <br className="hidden sm:block"/>in Smart Robotic <br className="hidden sm:block"/>Systems.</h1>
          </AnimatedSection>
          <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
            <AnimatedSection
              customAnimation={{ y: 30, opacity: 0, duration: 0.8, delay: 0.4 }}
            >
              <p className="text-[#18181a] text-lg lg:text-3xl max-w-xl font-semibold text-center md:text-left" style={{fontFamily: 'Gilroy, sans-serif'}}>We specialize in designing intelligent robotic systems that enhance efficiency, precision, and innovation across diverse industrial applications.</p>
            </AnimatedSection>
            <AnimatedSection
        ...
        <AnimatedSection 
          className="w-full md:w-1/2 ml-0 md:ml-10 min-h-[400px] sm:min-h-[500px] md:min-h-[650px] flex flex-col md:flex-row gap-1 sm:gap-4"
          customAnimation={{ y: 50, opacity: 0, duration: 1, delay: 0.8 }}
        >
          {/* Column 1 */}
          <div className="flex flex-col h-full gap-4 sm:gap-6 flex-1 md:flex-[0_0_36%] md:max-w-[34%] mb-4 md:mb-0">
            {/* 1st row: 60% */}
            <div className="bg-white rounded-3xl shadow flex flex-col items-end justify-end overflow-hidden relative flex-[0_0_55%] min-h-0">
              <img src="/images/Image_3.jpg" alt="Mike" className="w-full sm:h-full h-[180px] object-cover rounded-t-2xl  sm:min-h-[120px]" style={{ minHeight: '120px', maxHeight: '100%' }} />
            ...
            <div className="relative rounded-3xl shadow flex flex-col justify-between p-5 overflow-hidden h-full min-h-0 bg-[#e4c6fd] flex-[0_0_45%]">
              ...
              <div className="relative z-10 w-full flex flex-col justify-between h-full min-h-[120px]">
                <div>
                  <div className="font-semibold text-2xl md:text-3xl lg:text-4xl text-[#18181a] leading-tight mb-2" style={{fontFamily: 'Gilroy, sans-serif'}}>Technology Consulting</div>
                </div>
                <div>
                  <div className="text-[#18181a] leading-tight text-lg lg:text-xl font-semibold" style={{fontFamily: 'Gilroy, sans-serif'}}>Sometimes you need to <br className="hidden sm:block" /> look far to see close. Our <br className="hidden sm:block" /> experts help you make <br className="hidden sm:block" /> sense of technology.</div>
                </div>
              </div>
            </div>
          </div>
          {/* Column 2 */}
          <div className="flex flex-col h-full gap-6 flex-1 md:flex-[0_0_32%] md:max-w-[32%] mb-4 md:mb-0">
            {/* 1st row: 50% */}
            <div className="bg-[#A9FFCC] rounded-3xl overflow-hidden shadow flex flex-col justify-between p-4 md:p-6 h-full min-h-0 relative flex-[0_0_50%]">
              ...
              <div className="font-semibold text-2xl lg:text-[2.1rem] text-[#18181a] leading-tight mb-15 sm:mb-0 relative z-10" style={{fontFamily: 'Gilroy, sans-serif'}}>Infrastructure <br className="hidden sm:block" />& Engineering</div>
              <div className="text-[#18181a] leading-tight text-lg lg:text-xl font-semibold mt-auto relative z-10" style={{fontFamily: 'Gilroy, sans-serif'}}>It's not enough to have <br className="hidden sm:block" /> technology, you also <br className="hidden sm:block" />need to have the right <br className="hidden sm:block" /> tools to manage it <br className="hidden sm:block" /> day-to-day..</div>
            </div>
            {/* 2nd row: 50% */}
            <div className="bg-white rounded-3xl shadow flex flex-col items-end justify-end overflow-hidden relative flex-[0_0_50%] min-h-0">
              <img src="/images/Image_5.jpg" alt="Asgeir" className="w-full sm:h-full h-[180px] object-cover rounded-t-2xl min-h-[120px]" style={{ minHeight: '120px', maxHeight: '100%' }} />
              <div className="absolute left-0 bottom-3 sm:bottom-4 md:bottom-6 flex items-center gap-2 bg-white rounded-l-none rounded-full px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 md:py-2 shadow">
                <div>
          ...
          {/* Column 3 */}
          <div className="flex flex-col h-full gap-4 sm:gap-6 flex-1 md:flex-[0_0_28%] md:max-w-[28%] mb-4 md:mb-0">
            {/* 1st row: 35% */}
            <div className="bg-white rounded-3xl shadow flex flex-col items-end justify-end overflow-hidden relative flex-[0_0_40%] min-h-0">
              <img src="/images/InfrastructureEngineering.jpg" alt="Latisha" className="w-full h-[180px] sm:h-full object-cover rounded-t-2xl min-h-[80px]" style={{ minHeight: '80px', maxHeight: '100%' }} />
              <div className="absolute left-0 bottom-3 sm:bottom-4 md:bottom-6 flex items-center gap-2 bg-white rounded-l-none rounded-full px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 md:py-2 shadow">
                <div>
            ...
            <div className="font-semibold text-2xl lg:text-[2.1rem] text-[#18181a] leading-tight mb-15 relative z-10" style={{fontFamily: 'Gilroy, sans-serif'}}>Own Design <br className="hidden sm:block" /> & Production</div>
          ...
          {/* Column 4 */}
          <div className="flex flex-col h-full gap-4 sm:gap-6 flex-1 md:flex-[0_0_28%] md:max-w-[28%]">
            {/* 1st row: 35% */}
            ...
            <div className="font-semibold text-2xl lg:text-[2.1rem] text-[#18181a] leading-tight mb-15 relative z-10" style={{fontFamily: 'Gilroy, sans-serif'}}>Customized <br className="hidden sm:block" /> Solutions</div>
            ...
            <div className="bg-white rounded-3xl shadow flex flex-col items-end justify-end overflow-hidden relative flex-[0_0_43%] min-h-0">
              <img src="/images/Image_1.jpg" alt="Customized Solutions" className="w-full h-[180px] sm:h-full object-cover rounded-t-2xl min-h-[80px]" style={{ minHeight: '80px', maxHeight: '100%' }} />
              <div className="absolute left-0 bottom-3 sm:bottom-4 md:bottom-6 flex items-center gap-2 bg-white rounded-l-none rounded-full px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 md:py-2 shadow">
                <div>
